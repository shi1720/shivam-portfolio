...
knowledge.push({
  ...
  url: "https://shivamgupta.web.app/#about",
  content: {
    source:
    ...
    roles: [
      "Siloed: Founder and CEO since March 2025, Dubai. Software development and AI product studio serving 10+ global clients across finance, healthcare, SaaS and other sectors. Custom AI apps, agents, product strategy, evaluation, and adoption workshops. Reports 25+ hours saved per team per week.",
      ...
      "IgniteTech: Senior AI Product Engineer, contract, September 2025 to present. Product and engineering across multiple products; 12+ features and reported 25% activation improvement. Built various products across the product portfolio. Structured LLM outputs, prompt versioning, and graceful fallbacks. Full-stack development, AI engineering, and product management with technical and non-technical teams. Wore many hats including forward-deployed engineer and technical product manager, meeting customers to understand requirements, participating in sales-team discussions, and helping them deploy products. This combines technical delivery with direct customer and sales-team collaboration.",
      "Trilogy and portfolio assignment 2 Hour Learning: April 2024 to September 2025. Promoted to Senior December 2024. Helped ship Alpha learning apps to 5,000+ learners; co-built PowerPath and co-developed Incept. Resume reports 18% higher assessment scores, 32% engagement improvement, $1M+ annual Incept savings. Helped develop learning products and end-to-end AI systems for a pioneering, successful AI-first school network. These are overlapping portfolio roles, not additive years.",
      "Earlier: Spilll product management intern 2024; IIIT Delhi undergraduate researcher in 2023 on multiple projects across blockchain, applied AI, LLMs, human-centered design and entrepreneurship; Sensight Labs chatbot intern 2023; Giggles founder 2022 to 2023 (six-person team and resume-reported 2,000+ downloads); Bharat Electronics Limited summer researcher 2022.",
      "micro1: Senior AI Engineer, contract, March 2025 to present, per supplied resume. Coding and AI Domain Expert; created 500+ expert-reviewed coding tasks, reproducible RL environments and reference implementations. Promoted to Reviewer; reviewed peers, refined evaluation criteria and mentored contributors. Piloted project types later scaled to 300+ experts. Separately completed software and AI engineering training work through Scale AI; dates for Scale AI were not supplied.",
...
// Keep durable career facts alongside the generated project and background notes.
knowledge.push(...JSON.parse(fs.readFileSync("server/career-facts.json", "utf8")));
...
knowledge.push({
  ...
  url: "https://shivamgupta.web.app/#contact",
  content:
    "Shivam Gupta is an applied AI engineer, product builder and founder of Siloed, based in Dubai / Delhi. Open to full-time AI engineering, product engineering, product manager, technical product manager, and forward-deployed engineer roles, including remote work and relocation. Also available for project-based and contract software development and end-to-end product delivery through Siloed. Email shivam1720406@gmail.com. LinkedIn https://www.linkedin.com/in/shivamgupta-ai/. Services: AI workflow design, agents and internal tools, full-stack prototypes and products, evaluation and reliability, product modernization, AI adoption workshops. Do not invent rates, available calendar slots, client names, salaries or commitments. Visitors can email; this guide cannot send email or book meetings.",
});
knowledge.push({
  id: "lab",
  title: "Agent reliability lab",
  url: "https://shivamgupta.web.app/#lab",
  content:
