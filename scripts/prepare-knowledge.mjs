...
knowledge.push({
  ...
  content: {
    ...
    roles: [
      ...
      "Khoros: Senior AI Product Engineer, contract, September 2025–present. Led AI and analytics engineering on IRIS AI, transforming an enterprise social care and marketing suite built over years into a new product in three months, with five engineers and one designer. Earlier, worked as lead engineer to deliver IRIS for X in one month. Delivered 10 production AI features.",
      "IgniteTech: Senior AI Product Engineer, contract, September 2025–present. Product and engineering across multiple products; 12+ features and reported 25% activation improvement. Built MetricsHub, an AI usage analytics and automated executive-briefing platform. Structured LLM outputs, prompt versioning, and graceful fallbacks. Full-stack development, AI engineering, and product management with technical and non-technical teams. Wore many hats including forward-deployed engineer and technical product manager, meeting customers to understand requirements and helping them deploy products.",
